...
function Navbar() {
  ...
  return (
        <div class="flex items-center justify-between">
            <div class="m-2 font-medium sm:text-lg md:text-2xl md:tracking-widest">
                <h1>MODE UI</h1>
            </div>

            <div class="p-0.1 hidden lg:inline-block">
                <button class="m-2 rounded-lg p-2 text-lg font-medium hover:bg-purple-100 hover:text-violet-950 m-1">Card Access
                </button>
                <button class="m-2 rounded-lg p-2 text-lg font-medium hover:bg-purple-100 hover:text-violet-950">Banking</button>
                <button class="m-2 rounded-lg p-2 text-lg font-medium hover:bg-purple-100 hover:text-violet-950">Processing</button>
                <button class="m-2 rounded-lg p-2 text-lg font-medium hover:bg-purple-100 hover:text-violet-950">About</button>
                <button class="m-2 rounded-lg p-2 text-lg font-medium hover:bg-purple-100 hover:text-violet-950">Carrier</button>
                <button class="m-2 rounded-lg p-2 text-lg font-medium hover:bg-purple-100 hover:text-violet-950">Contact</button>
            </div>

            <div class="flex p-2">
                <button class="m-2 bg-slate-100 px-2 py-2 text-lg font-mono md:px-6 flex rounded-lg">Login <CiLogin className='mt-1
                p-1 arrow-icon font-bold text-2xl'/> </button>

                <button class="p-0.1 m-2 bg-slate-100 px-2 py-2 text-lg font-medium sm:inline-block lg:hidden md:px-6 rounded-lg" onClick={()=>setToogle(!toggle)}> <MdOutlineDensityMedium className='text-purple-700'/>
